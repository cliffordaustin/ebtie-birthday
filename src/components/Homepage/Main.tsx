...
function Main({
  ...
  return (
    <>
      <div className="h-[25rem] md:h-[34rem] flex w-full relative after:bg-black after:inset-0 after:absolute after:bg-opacity-40">
        ...
        <div className="z-40 absolute bottom-9 md:bottom-32 left-2/4 -translate-x-2/4 flex flex-col justify-center items-center w-full">
          ...
          <div className="flex md:flex-row flex-col items-center justify-center gap-2 md:gap-4">
            <button
              ...
              className="px-8 py-2 backdrop-blur-sm border bg-yellow-300/10 border-yellow-500/20 text-white mx-auto text-center relative mt-4 w-[250px] md:w-auto"
            >
            ...
            <Link href={`/user-profile`} target="_blank">
              <button className="px-8 py-2 backdrop-blur-sm border bg-yellow-300/10 border-yellow-500/20 text-white mx-auto text-center relative mt-4 w-[250px] md:w-auto">
